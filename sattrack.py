...
legend = tk.Label(window, text="Frequencies — NOAA 15: 137.620 MHz    NOAA 18: 137.9125 MHz    NOAA 19: 137.100 MHz", font=("Arial", 10))
legend.grid(row=2, column=1, pady=(0, 10))
